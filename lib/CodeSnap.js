...
class CodeSnap {
    ...
    snap(code) {
        return __awaiter(this, void 0, void 0, function* () {
            const carbonUrl = (0, utils_1.composeCarbonUrl)(this.theme, this.backgroundColor, this.numberLines, code);
            ...
            if (element) {
                ...
                yield browser.close();
                console.log(buffer);
                yield (0, sharp_1.default)(buffer).toFile(__dirname + 'output_image.png');
            }
        });
    }
}
